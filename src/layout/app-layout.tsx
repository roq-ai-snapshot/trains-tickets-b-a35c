...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['customer-service-representative', 'business-owner', 'team-member', 'it-administrator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Stations', path: '/stations', entity: 'station', service: AccessServiceEnum.PROJECT, icon: FiMapPin },

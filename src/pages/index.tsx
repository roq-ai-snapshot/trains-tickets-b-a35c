...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Trains Tickets Booking Application`}</title>

        <meta
          name="description"
          content="Experience seamless journey planning with Trains Tickets Booking Application - your go-to platform for online ABC train tickets booking, trusted by millions."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1683279705401-f3fab8c566c9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0cmFpbiUyMHRpY2tldHN8ZW58MHx8fHwxNjk3MDgzNDgwfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@booklarking?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Trains Tickets Booking Application`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless journey planning with Trains Tickets Booking Application - your go-to platform for online ABC train tickets booking, trusted by millions.`}
            </Text>
            <Box
